...
function SignUp() {
    ...
    */
    ...
    const passwordCriteria = [
        ...
        { id: 2, label: "Contains an uppercase letter", isValid: /[A-Z]/.test(password) },
        ...
        <div className="bg-white w-full max-w-[1408px] py-8 px-24 mx-4">
            <div className="flex justify-center items-center">
                <div className="flex-1 flex justify-center items-center px-[104px]">
                    <form onSubmit={handleSubmit(onSubmit)} className="flex-1 flex flex-col gap-6 max-w-[384px]">
                        ...
                        <ul>
                            {
                                passwordCriteria.map((criterion) => (
                                    <li key={criterion.id} className={criterion.isValid ? "text-green-500" : "text-neutral-300"}>
                                        {criterion.label}
                                    </li>
                                ))
                            }
